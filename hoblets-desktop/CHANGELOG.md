...
- Hoblets now has its own app identity, separate from Kommandr.
- Install this version once from hoblets.com/download; future Hoblets updates use the new dedicated update channel.
- Keeps your existing Hoblets desktop profile and account. Kommandr continues using its original app and update channel.
