...
### Highlights
- Kommandr is available again as its own desktop and mobile app, with the original K icon and existing account access.

### Fixes
- Restored kommandr.com, account and membership pages, and downloads that follow Kommandr's own release feed.
- Kept the existing desktop updater and mobile app identity so current Kommandr users can update. Kommandr and Hoblets now publish separate apps and release notes.
